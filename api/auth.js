...
module.exports = function(req, res) {
  ...
  const params = new URLSearchParams({
    ...
    scope: 'manage_assets read_customers manage_customers read_customer_contacts manage_staff read_staff read_job_contacts manage_job_contacts read_jobs manage_jobs create_jobs read_job_materials read_materials read_job_categories read_job_queues read_job_payments read_tasks read_schedule staff_activity staff_locations read_job_checklists manage_job_checklists',
    state:         statePayload
  });
